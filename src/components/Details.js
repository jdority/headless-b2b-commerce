                                    ...
                                    <div className="container py-5">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-10 mx-auto col-md-6 my-3 text-capitalize">
                                                ...
                                                <h4 className="text-blue"><strong>price : <span>$</span>{price?price.toFixed(2):"CALL"}</strong></h4>
                                                ...
                                                <div>
                                                    ...
                                                    <ButtonContainer cart disabled={inCart ? true : false} onClick={() => { value.addToCart(id,auth); value.openModal(id) }}>
